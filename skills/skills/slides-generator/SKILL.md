...
description: Create Binance-branded PDF slides from markdown with Mermaid diagram support. Use for presentations, decks, and technical documentation with professional diagrams.
---

# slides-generator

Create Binance-branded presentation slides in PDF format from markdown content. Features two-column layouts and Mermaid diagram rendering for technical architecture and flowcharts.
...
```bash
bash <(curl -s https://raw.githubusercontent.com/agentwxo/skills/main/skills/slides-generator/scripts/generate_slides.sh) \
...
Use `style NodeName fill:#00D084,color:#fff` for green highlighting.
