...
| **aroon**      | Trending & volatile assets | Aroon Oscillator spread adjustment, FIFO position tracking, auto take-profit |
...
**aroon**: Advanced controller using the Aroon Oscillator. Dynamically narrows bid spread in uptrends and ask spread in downtrends. Automatically manages take-profit orders and tracks positions via FIFO from the SQLite database. See `aroon.md` for full parameter reference.
